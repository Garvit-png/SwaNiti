...
const ShaderBackground = () => {
  ...
  const fsSource = `
    ...
    // Suited color for the theme (dark green lines)
    ...
    void main() {
      ...
      // Removed opaque background colors to allow CSS gradient to show through
      ...
      fragColor = vec4(0.0); // Fully transparent base
      fragColor += lines;
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      // Need to use parent dimensions if inside a container, or offsetWidth
